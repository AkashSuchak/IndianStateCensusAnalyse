...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\IndiaStateCensusData.csv";
        static string wrongDataFilePath = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\IndianData.csv";
        static string IndianStateCensus = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\IndianStateCensus.txt";
        static string wrongIndianStateCensusFileHeader = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\WrongIndiaStateCensusData.csv";
        static string IndianStateCesusFilePathWithWrongDelimeter = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\IndianStateCesusDelimeter.csv";

        static string indianStateCodeHeaders = @"SrNo,State Name,TIN,StateCode";
        static string indianStateCodePath = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\IndiaStateCodes.csv";
        static string WrongIndianStateCodeFilePath = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\WrongIndiaStateCodes.csv";
        static string WrongIndianStateCodeFileTypePath = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\WronTypeIndiaStateCodes.txt";
        static string IndianStateCodeFilePathWrongDelimeter = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\DelimiterIndiaStateCodes.csv";
        static string IndianStateCodeFilePathWrongHeader = @"C:\Users\DELL\source\repos\IndianStateCensusAnalyse\CensusAnalyserTest\CsvFiles\WrongHeaderIndiaStateCodes.csv";
